...
import android.app.Activity; //added libraries
...
public class SerialConsoleActivity extends Activity implements TextureView.SurfaceTextureListener  {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            int startY = 200;//350;//15; // which row in the bitmap to analyse to read
            ...
            if (wbTotal<=0) {
                COM = (short) (bmp.getWidth()/2);
            }
            else {
                COM = (short) (wbCOM/wbTotal);
            }
        ...
        /**
        final Canvas c2 = mSurfaceHolder.lockCanvas();

        if (c2 != null) {

            int[] pixels2 = new int[bmp.getWidth()];
            int startY2 = 200;//15; // which row in the bitmap to analyse to read
            // only look at one row in the image
            ...
            //watch out for divide by 0
            if (wbTotal2 <= 0) {
                COM2 = (short) (bmp.getWidth() / 2);
            } else {
                COM2 = (short) (wbCOM2 / wbTotal2);
            }
            ...
            // also write the value as text
            canvas.drawText("COM = " + COM2, 10, 350, paint1);
        ...
        final Canvas c3 = mSurfaceHolder.lockCanvas();
        ...
        if (c3 != null) {
            ...
            //watch out for divide by 0
            if (wbTotal3 <= 0) {
                COM3 = (short) (bmp.getWidth() / 2);
            } else {
                COM3 = (short) (wbCOM3 / wbTotal3);
            }
            ...
            // also write the value as text
            canvas.drawText("COM = " + COM3, 10, 20, paint1);
            c3.drawBitmap(bmp, 0, 0, null);
            mSurfaceHolder.unlockCanvasAndPost(c3);
    ...
    private void updateReceivedData(byte[] data) {
        ...
        byte[] sData = {'a','P',(byte)(COM & 0xff),(byte)((COM >> 8) & 0xff)};
